...
public class SparkLauncher extends Launcher {
	...
	public PigStats launchPig(PhysicalPlan physicalPlan, String grpName,
		...
		currentDirectoryPath = Paths.get(".").toAbsolutePath()
				.normalize().toString()
				+ "/";
		startSparkJob();
    ...
    private void addUDFJarToSparkJobWorkingDirectory(SparkOperator leaf) throws IOException {
    ...
    private void sparkOperToRDD(SparkOperPlan sparkPlan,
			...
			throws IOException, InterruptedException {
        addUDFJarToSparkJobWorkingDirectory(sparkOperator);
