    ...
    public void visitSparkOp(SparkOperator sparkOp) throws VisitorException {
        try {
            ...
            if (splittees.size() == 1) {
                ...
                //for the first element of roots, merge the physical plan of spliter and splittee's sub plan
                //for the other elements of roots,merge the clone physical plan of spliter and splittee's sub plan
