 ...
 */
public class JoinOptimizerSpark extends SparkOpPlanVisitor {
    private static final Log LOG = LogFactory.getLog(JoinOptimizerSpark.class);

    public JoinOptimizerSpark(SparkOperPlan plan) {
